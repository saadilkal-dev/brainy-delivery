...
export const mockModules: Module[] = [
  ...
  },
  {
    ...
    description: 'Real-time parts inventory tracking and reorder alerts',
    owner: 'Meera',
    status: 'in_progress',
    progress_pct: 45,
    estimated_hours: 90,
    ...
    order: 6,
    assumptions: [
      { id: 'asm-5', module_id: 'mod-6', text: 'Inventory API supports real-time sync', status: 'pending', risk_level: 'high', created_at: '2026-03-10T10:00:00Z' },
    ],
    dependencies: [
      { id: 'dep-4', module_id: 'mod-6', description: 'Parts catalog CSV from warehouse team', owner: 'Daikin Warehouse', type: 'client', expected_date: '2026-03-18', status: 'overdue', days_overdue: 12, created_at: '2026-03-10T10:00:00Z' },
    ],
    created_at: '2026-03-10T10:00:00Z',
    updated_at: '2026-03-28T10:00:00Z',
  },
  {
    ...
    description: 'Calendar-based scheduling and dispatch for field technicians',
    owner: 'Karthik',
    status: 'blocked',
    progress_pct: 20,
    estimated_hours: 110,
    ...
    order: 7,
    blocker_reason: 'Waiting on shift pattern data from HR',
    assumptions: [
      { id: 'asm-6', module_id: 'mod-7', text: 'Max 3 service calls per technician per day', status: 'confirmed', risk_level: 'medium', created_at: '2026-03-15T10:00:00Z' },
    ],
    dependencies: [
      { id: 'dep-5', module_id: 'mod-7', description: 'Shift pattern data from Daikin HR', owner: 'Daikin HR', type: 'client', expected_date: '2026-03-22', status: 'overdue', days_overdue: 8, created_at: '2026-03-15T10:00:00Z' },
    ],
  ...
  },
  {
    ...
    description: 'Post-service feedback collection and NPS tracking',
    owner: 'Meera',
    status: 'complete',
    progress_pct: 100,
    estimated_hours: 50,
  ...
  // ── HealthSync Patient Portal (proj-3) ──
  {
    id: 'mod-p3-1',
    project_id: 'proj-3',
    name: 'Patient Registration',
    description: 'Self-service patient sign-up with insurance verification',
    owner: 'Priya',
    status: 'in_progress',
    progress_pct: 55,
    estimated_hours: 80,
    ...
    order: 1,
    assumptions: [
      { id: 'asm-p3-1', module_id: 'mod-p3-1', text: 'Insurance API supports real-time verification', status: 'pending', risk_level: 'high', created_at: '2026-03-05T10:00:00Z' },
    ],
    dependencies: [
      { id: 'dep-p3-1', module_id: 'mod-p3-1', description: 'Insurance provider API credentials', owner: 'MediCorp IT', type: 'client', expected_date: '2026-03-20', status: 'overdue', days_overdue: 11, created_at: '2026-03-05T10:00:00Z' },
    ],
    created_at: '2026-03-01T10:00:00Z',
    updated_at: '2026-03-28T10:00:00Z',
  },
  {
    ...
    description: 'Calendar-based appointment scheduling with doctor availability',
    owner: 'Arjun',
    status: 'in_progress',
    progress_pct: 40,
    estimated_hours: 100,
  ...
  },
  {
    ...
    description: 'Secure viewer for patient history and lab results',
    owner: 'Ravi',
    status: 'blocked',
    progress_pct: 15,
    estimated_hours: 120,
    ...
    order: 3,
    blocker_reason: 'HIPAA compliance audit pending — cannot proceed without clearance',
    assumptions: [
      { id: 'asm-p3-2', module_id: 'mod-p3-3', text: 'HL7 FHIR standard will be used for data exchange', status: 'confirmed', risk_level: 'medium', created_at: '2026-03-15T10:00:00Z' },
    ],
    dependencies: [
      { id: 'dep-p3-2', module_id: 'mod-p3-3', description: 'HIPAA compliance sign-off from legal', owner: 'MediCorp Legal', type: 'client', expected_date: '2026-03-25', status: 'overdue', days_overdue: 6, created_at: '2026-03-15T10:00:00Z' },
    ],
    created_at: '2026-03-15T10:00:00Z',
    updated_at: '2026-03-29T10:00:00Z',
  },
  {
    ...
    description: 'Video consultation module with Zoom SDK',
    owner: 'Meera',
    status: 'not_started',
    progress_pct: 0,
    estimated_hours: 90,
  ...
  // ── EduTrack LMS Platform (proj-4) ──
  {
    ...
    order: 1,
    assumptions: [
      { id: 'asm-p4-1', module_id: 'mod-p4-1', text: 'Video content will be hosted on S3, not embedded', status: 'confirmed', risk_level: 'low', created_at: '2026-03-10T10:00:00Z' },
    ],
    dependencies: [],
    created_at: '2026-03-10T10:00:00Z',
    updated_at: '2026-03-29T10:00:00Z',
  },
  {
    ...
    description: 'Progress tracking, grades, and upcoming assignments',
    owner: 'Priya',
    status: 'in_progress',
    progress_pct: 30,
    estimated_hours: 70,
    ...
    assumptions: [],
    dependencies: [
      { id: 'dep-p4-1', module_id: 'mod-p4-2', description: 'Grading rubric finalization from BrightLearn', owner: 'BrightLearn Curriculum', type: 'client', expected_date: '2026-03-28', status: 'overdue', days_overdue: 3, created_at: '2026-03-15T10:00:00Z' },
    ],
    created_at: '2026-03-15T10:00:00Z',
    updated_at: '2026-03-28T10:00:00Z',
  },
  {
    ...
    project_id: 'proj-4',
    name: 'Quiz Engine',
    description: 'Auto-graded quizzes with multiple question types',
    owner: 'Arjun',
    status: 'complete',
    progress_pct: 100,
    estimated_hours: 60,
  ...
  },
  {
    ...
    project_id: 'proj-4',
    name: 'Live Classroom',
    description: 'Real-time virtual classroom with whiteboard and chat',
    owner: 'Meera',
    status: 'blocked',
    progress_pct: 10,
    estimated_hours: 130,
    ...
    order: 4,
    blocker_reason: 'WebRTC vendor selection delayed — awaiting procurement approval',
    assumptions: [
      { id: 'asm-p4-2', module_id: 'mod-p4-4', text: 'Max 50 concurrent users per classroom session', status: 'pending', risk_level: 'medium', created_at: '2026-04-01T10:00:00Z' },
    ],
    dependencies: [
      { id: 'dep-p4-2', module_id: 'mod-p4-4', description: 'WebRTC vendor contract approval', owner: 'BrightLearn Procurement', type: 'client', expected_date: '2026-03-30', status: 'overdue', days_overdue: 1, created_at: '2026-04-01T10:00:00Z' },
    ],
