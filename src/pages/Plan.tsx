  ...
  return (
    <div className="space-y-6">
      ...
      <motion.div
        ...
        className="rounded-sm border border-primary/20 bg-primary/[0.03] p-5 amber-glow"
      >
        ...
        <div className="space-y-2">
          {modules.map((mod, i) => (
            <motion.div
              ...
              className="rounded-sm border border-white/[0.07] bg-card overflow-hidden"
            >
              <button
      ...
      {showAddModule && (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-background/80 backdrop-blur-sm">
          <motion.div
            ...
            className="bg-card border border-white/[0.08] rounded-sm p-6 w-full max-w-md space-y-4 shadow-2xl shadow-black/40"
          >
